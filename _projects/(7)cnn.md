...
In this project, I followed a [handwritten digit recognition tutorial](https://www.kaggle.com/code/itsmohammadshahid/7-cnn-handwritten-digit-recognition) on Kaggle to implement CNN model. The training data is from MNIST digits classification dataset from Keras.
...
Through this project, I have a better understanding of CNNs, including how the convolutional layers extract features in the picture and how to fine-tune hyperparameters to improve model performance.
